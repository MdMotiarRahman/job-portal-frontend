...
const FAQS = [
  ...
  { q: 'Is JobLand free to use?', a: 'Yes! Job seekers can browse and apply for jobs completely free. Employers can post jobs with our free tier, with premium plans available for advanced features.' },
  ...
  { q: 'How do I contact support?', a: 'Visit our Contact page or email support@jobland.com. We typically respond within 24 hours.' },
];
    ...
    <div className="pp-page">
      <div className="pp-container">
        <div className="pp-page-header">
          ...
          <p>Find quick answers to common questions about JobLand.</p>
        </div>
